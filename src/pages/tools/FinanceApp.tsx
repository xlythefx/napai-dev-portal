...
import { ArrowLeft, Wallet, BarChart3 } from "lucide-react";
    ...
    <section className="pt-28 pb-24 px-4">
      <div className="container mx-auto max-w-3xl">
        ...
        >
          ...
          <h1 className="text-3xl font-bold mb-2">Finance App</h1>
          <p className="text-muted-foreground mb-8">
            Track expenses, income, and budgets with smart analytics. Coming soon.
          </p>
