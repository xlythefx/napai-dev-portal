    ...
    <section className="pt-28 pb-24 px-4">
      <div className="container mx-auto max-w-3xl">
        ...
        >
          ...
          <h1 className="text-3xl font-bold mb-2">AI Accounting Tool</h1>
          <p className="text-muted-foreground mb-8">
            Smart bookkeeping, invoice tracking, and financial insights. Coming soon.
          </p>
...
export default AIAccountingTool;
